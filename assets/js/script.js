...
// modal
// create
const openCreateModal = document.querySelector(".crDiario"),
  closeCreateModal = document.querySelector(".modalCreateClose"),
  createModal = document.querySelector(".modalCreate");
...
const openReadModal = document.querySelectorAll(".read"),
  closeReadModal = document.querySelector(".modalReadClose"),
  readModal = document.querySelector(".modalRead");

openReadModal.forEach((readOpen) => {
  readOpen.addEventListener("click", () => {
